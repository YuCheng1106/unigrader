#!/usr/bin/env python3
# -*- coding: utf-8 -*-
from sqlalchemy import TEXT, Float, Integer, String, JSON, Enum
...
class ExamQuestion(Base):
    ...
    exam_id: Mapped[int] = mapped_column(Integer, ForeignKey('exam.id'), nullable=False, comment='对应的exam的id')
