...
class SubmissionAnswer(Base):
    ...
    submission_id: Mapped[int] = mapped_column(Integer, ForeignKey('submission.id'), nullable=False, comment='对应的提交id')
    exam_question_id: Mapped[int] = mapped_column(Integer, ForeignKey('exam_question.id'), nullable=False, comment='对应的考试题目id')
    ...
    graded_by_id: Mapped[int | None] = mapped_column(Integer, ForeignKey('sys_user.id'), default=None, comment='被谁批改的用户id')
