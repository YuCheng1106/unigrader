...
from plugin.exam.schema.banji import CreateBanjiParam, DeleteBanjiParam, GetBanjiDetail, UpdateBanjiParam
from plugin.exam.service.banji_service import banji_service
